<template>
  <div>
    <div class="mb-3" :class="{ 'shortlist-container': individuals.length > 0 }">
      <ShortlistIndividualItem v-for="(e, index) in individuals" :key="`ShortlistIndividualItem-${e.id}`" :data="e" :index="index" @click="showDetails" />
...
import ShortlistIndividualItem from '~/components/ShortlistIndividualItem'

export default {
  name: 'ShortlistIndividualPage',

  components: { ShortlistIndividualItem },
